...
public class LoanControllerTest {
    ...
    @Test
    void testGetLoanInfoByCustomerIdEquals1() throws Exception, LoanException  {
        Long reqParam = 1L;
    ...
    @Test
    void testGetLoanInfoByCustomerIdEquals2() throws Exception, LoanException  {
        Long reqParam = 1L;
        ...
        assertEquals("info not found", status.get("message").toString());
    ...
    @Test
    void testGetLoanInfoByCustomerIdEquals3() throws Exception, LoanException  {
        Long reqParam = 3L;
        when(loanService.getLoanInfoById(reqParam)).thenThrow(
        ...
        assertEquals("cannot get loan info", status.get("message").toString());
        assertEquals("cannot get loan info", resp.get("data").toString());
